...
internal fun saveTargetDate(context: Context, appWidgetId: Int, time: Long) {
    context.getSharedPreferences(PREFS_NAME, 0).edit().putLong(PREF_PREFIX_KEY + appWidgetId, time)
        .apply()
}
...
internal fun saveCustomText(context: Context, appWidgetId: Int, text: String) {
    context.getSharedPreferences(PREFS_NAME, 0).edit().putString(PREF_TEXT_KEY + appWidgetId, text)
        .apply()
}

internal fun loadCustomText(context: Context, appWidgetId: Int): String {
    return context.getSharedPreferences(PREFS_NAME, 0)
        .getString(PREF_TEXT_KEY + appWidgetId, "Label") ?: "Label"
}

internal fun saveWidgetColor(context: Context, appWidgetId: Int, color: Int) {
    context.getSharedPreferences(PREFS_NAME, 0).edit().putInt(PREF_COLOR_KEY + appWidgetId, color)
        .apply()
}

internal fun loadWidgetColor(context: Context, appWidgetId: Int): Int {
    return context.getSharedPreferences(PREFS_NAME, 0)
        .getInt(PREF_COLOR_KEY + appWidgetId, Color.parseColor("#42A5F5"))
}
